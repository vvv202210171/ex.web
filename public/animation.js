...
window.startCanvas = function () {
  ...
  canvas.style.cssText = "width:100%;height:100%;position:absolute;opacity:" + attr.opacity;
  //将canvas元素添加到body元素中
  document.getElementsByClassName("canvasBox")[0].appendChild(canvas);
  ...
  function getAttr() {
    ...
    return {
      ...
      color: script.getAttribute("color") || "225,225,225",
