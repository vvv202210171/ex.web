...
function chackRate() {
  ...
  return !(e >= times) || (window.console.log("@@@@@@按钮点击频率太快"), !1)
}
...
!function (e) {
  ...
  e.angular.bootstrap ? window.console.log("WARNING: Tried to load angular more than once.") : ((zt = e.jQuery) && zt.fn.on ? (Vt = zt, f(zt.fn, {
    scope: $n.scope,
  ...
  function ne() {
    if (!isNaN(parseInt(ce.w)) && (ce.w = 0 | ce.w, ce.w >= 0)) {
      try {
        ...
        try {
          "console" in window && window.console.log("Warning: " + ce.w)
        } catch (e) {
        }
      }
      i()
...
app.config(["$translateProvider", "$httpProvider", function (e, t) {
  ...
  if (window.console.log = function () {
  ...
  e.selectProduct = function (t, n, r, o) {
    ...
    if (t.stopPropagation(), o) e.Islogin ? n.post("/exchange/private/deletePortfolio", $.param({symbol: r})).success(function (t) {
      ...
      e.getProNum()
    }) : (window.console.log("未登录，删除本地"), angular.forEach(e.products, function (e, t) {
      r == e.symbol && (e.pro = !1)
    }), e.getProNum(), e.removeByValue(e.localListData, r), localStorage.sortLists = JSON.stringify(e.localListData), window.console.log(localStorage.sortLists)); else if (e.Islogin) n.post("/exchange/private/addPortfolio", $.param({symbol: r})).success(function (t) {
      for (var n = 0; n < e.products.length; n++) r == e.products[n].symbol && (e.products[n].pro = !0);
      e.getProNum()
    }); else {
      window.console.log("未登录，添加到本地");
      for (var i = 0; i < e.products.length; i++) r == e.products[i].symbol && (e.products[i].pro = !0, e.localListData.push(e.products[i].symbol));
      e.getProNum(), localStorage.sortLists = JSON.stringify(e.localListData), window.console.log(JSON.parse(localStorage.sortLists).length)
    }
  ...
  var ae = function (e) {
    ...
    window.console.log("Error parsing resolution: " + e)
  };
  ...
  var ye = function (t) {
    if ("depthUpdate" == t.eventType) {
      window.console.log(t.bids), L(t.bids, e.streamBids), L(t.asks, e.streamAsks);
    ...
    } else "kline" == t.eventType ? t.kline.interval == le && Data.onBar([t.kline.time, Number(t.kline.open), Number(t.kline.high), Number(t.kline.low), Number(t.kline.close), Number(t.kline.volume), Number(t.kline.quoteVolume)], Number(se)) : (window.console.log("Error! Bad data received:"), window.console.log(t))
  }, xe = 280;
  ...
  e.userCallback = function (t) {
    if ("outboundAccountInfo" == t.eventType && t.balances.forEach(function (t) {
      ...
      switch (n.time = t.time, n.symbol = t.symbol, n.side = t.side, n.type = t.orderType, n.orderType = d.instant(n.type), n.status = t.orderStatus, n.workingIndicator = t.workingIndicator, n.origQty = parseFloat(t.qty), n.price = parseFloat(t.price), n.stopPrice = parseFloat(t.stopPrice), n.executedQty = parseFloat(t.cummulativeQty), n.commissionAsset = t.commissionAsset, n.orderId = t.orderId, "STOP_LOSS_LIMIT" != n.type && "TAKE_PROFIT_LIMIT" != n.type || (n.orderType = d.instant("Stop-Limit")), t.orderStatus) {
        case"NEW":
          n.executedQty = 0, n.executedPrice = 0, window.console.log(n.symbol + " 委托" + n.origQty), "LIMIT" == n.type || "MARKET" == n.type ? (e.openOrders.splice(0, 0, n), e.IsopenOrdersNull = !1) : "STOP_LOSS_LIMIT" != n.type && "TAKE_PROFIT_LIMIT" != n.type || (n.workingIndicator ? angular.forEach(e.openOrders, function (t, r) {
        ...
        case"FILLED":
          ...
          window.console.log(t), e.openOrders instanceof Array && e.openOrders.forEach(function (e) {
      ...
      n.get("/exchange/public/wssUrl").success(function (o) {
        ...
        r(function () {
          n({
            ...
            window.console.log("pingStream success")
          })
...
app.factory("streamer", ["$http", "$interval", function (e, t) {
  return function () {
    ...
    return n.isRunning = !1, n.restart = !1, n.root_url = location.host.match("localhost") || location.host.match("192.168.0") ? "/exchange/public" : "/api/v1", n.startStream = function (e, t, r, o) {
      ...
      window.console.log("Rolling over stream!"), n.backedMsg = [], n.buildingState = !0, n.wsbuildingState = !0, n.stateChange(!0), n.ws = n._makeStream()
    }, n._makeStream = function () {
      var r = new WebSocket(n.url + "/" + n.lowerCaseSymbol + "@depth.b10");
      return n._buildState(), r.onopen = function () {
        window.console.log("Socket has been opened for: " + n.symbol + "!"), n.lastConntectTime = new Date, n.wsbuildingState = !1, n.stateChange(!(0 == n.buildingState && 0 == n.wsbuildingState)), clearInterval(t)
      }, r.onclose = function (e) {
        window.console.log("Socket has been CLOSED for: " + n.symbol + "!"), n.wsbuildingState = !0, n.stateChange(!0), r.handClose ? (r.handClose = !1, window.console.log("Socket done!")) : (new Date).getTime() - n.lastConntectTime.getTime() < 12e4 ? setTimeout(function () {
          window.console.log("streamer reconntect delay=========="), n._rolloverStream()
        }, 1e3) : (window.console.log("streamer reconntect now=========="), n._rolloverStream())
      }, r.onmessage = function (e) {
        if (r == n.ws) {
          var t = JSON.parse(e.data);
          window.console.log("WS recv: " + t), t = n.converter(t), n.buildingState ? (n.backedMsg.push(t), window.console.log("Adding msg to backlog: " + t)) : n._isLoss(t) ? (n.backedMsg = [], n.backedMsg.push(t), n.buildingState = !0, n.stateChange(n.buildingState), n._buildState()) : n.processData(t)
        }
        ...
        n.wsbuildingState = !0, n.stateChange(!0), t || (t = setInterval(function () {
          ...
          window.console.log("streamer reconntect now=========="), n.stopStream(), n._rolloverStream()
        }, 6e4)
      }, r
    }, n.RePull = function () {
      ...
      var r = function () {
        e(t).success(function (e) {
          n.lastDepthId = -1;
          var t = {};
          t.eventType = "depthUpdate", t.updateId = e.lastUpdateId, t.bids = e.bids, t.asks = e.asks, t.clean = !0, window.console.log("GET All Depth Success "), n.processData(t), window.console.log("Initial state set!"), window.console.log("Replaying " + n.backedMsg.length + " backed msgs!");
          var o = !1;
          ...
          o || n.backedMsg.forEach(function (e, t) {
            n.processData(e), window.console.log("Replayed: " + e.eventType)
      ...
      var t = {};
      return t.eventType = e.e, t.eventTime = e.E, t.symbol = e.s, t.kline = e.k, "depthUpdate" == t.eventType ? (t.event = e.e, t.eventTime = e.E, t.symbol = e.s, t.updateId = e.u, t.fupdateId = e.U, t.bids = e.b, t.asks = e.a) : (window.console.log("Error! Bad data received:"), window.console.log(t)), t
    }, n._isDuplicate = function (e) {
      if ("depthUpdate" == e.eventType) {
        if (e.updateId > n.lastDepthId) return n.lastDepthId = e.updateId, !1
      } else window.console.log("Error! Bad data received:"), window.console.log(e);
      return !0
    }, n._isLoss = function (e) {
      if ("depthUpdate" == e.eventType) {
        if (e.fupdateId <= n.lastDepthId + 1) return !1
      } else window.console.log("Error! Has Loss data");
      return !0
    }, n._clear = function (e) {
  ...
  return function () {
    ...
    return e.isRunning = !1, e.restart = !1, e.lastConntectTime = new Date, e.startStream = function (t, n) {
      ...
      window.console.log("Rolling over stream!"), e.backedMsg = [], e.buildingState = !0, e.ws = e._makeStream()
    }, e._makeStream = function () {
      var t = new WebSocket(e.url);
      return t.onopen = function () {
        window.console.log("Socket has been opened for: market data!"), e.lastConntectTime = new Date, e._buildState()
      }, t.onclose = function (t) {
        window.console.log("Socket has been CLOSED for: market data!"), e.restart ? (new Date).getTime() - e.lastConntectTime.getTime() < 12e4 ? setTimeout(function () {
          window.console.log("streamer reconntect delay=========="), e._rolloverStream()
        }, 1e3) : (window.console.log("streamer reconntect now=========="), e._rolloverStream()) : (delete e.ws, window.console.log("Socket done!"))
      }, t.onmessage = function (t) {
        var n = JSON.parse(t.data);
        n = e.converter(n), window.console.log("User data WS recv, eventType: " + n.eventType + ", eventTime: " + n.eventTime), e.buildingState ? (e.backedMsg.push(n), window.console.log("Adding msg to backlog: " + n.eventType)) : e.processData(n)
      }, t
  ...
  return function () {
    ...
    return e.isRunning = !1, e.restart = !1, e.lastTradeId = -1, e.root_url = location.host.match("localhost") || location.host.match("192.168.0") ? "/exchange/public" : "/api/v1", e.startStream = function (t, n, r, o) {
      ...
      window.console.log("Rolling over stream!"), e.backedMsg = [], e.ws = e._makeStream()
    }, e._makeStream = function () {
      var t = new WebSocket(e.url + "/" + e.lowerCaseSymbol + "@kline_" + e.interval + ".b10");
      return n.websocketStatus = "connecting", t.onopen = function () {
        n.websocketStatus = "connected", window.console.log("Socket has been opened for: " + e.symbol + "!"), e.lastConntectTime = new Date
      }, t.onclose = function (r) {
        window.console.log("Socket has been CLOSED for: " + e.symbol + "!"), t.HandClose ? (t.HandClose = !0, window.console.log("Socket done!")) : (n.websocketStatus = "reconnecting", (new Date).getTime() - e.lastConntectTime.getTime() < 12e4 ? setTimeout(function () {
          window.console.log("streamer reconntect delay=========="), e._rolloverStream()
        }, 1e3) : (window.console.log("streamer reconntect now=========="), e._rolloverStream()))
      }, t.onerror = function () {
        n.websocketStatus = "error"
      }, t.onmessage = function (t) {
        var n = JSON.parse(t.data);
        n = e.converter(n), window.console.log("WS recv: " + n), e.processData(n)
      }, t
    }, e.converter = function (e) {
      var t = {};
      ...
      return "kline" != e.eventType && (window.console.log("Error! Bad data received:"), window.console.log(e), !0)
    }, e._clear = function (e) {
      e.onopen = null, e.onmessage = null, e.onerror = null, e.onclose = null
    }, e
  }
...
app.factory("tradeStreamer", ["$http", "$interval", function (e, t) {
  return function () {
    ...
    return t.isRunning = !1, t.restart = !1, t.lastAggTradeId = -2, t.root_url = location.host.match("localhost") || location.host.match("192.168.0") ? "/exchange/public" : "/api/v1", t.startStream = function (e, n, r) {
      ...
      window.console.log("Rolling over stream!"), t.backedMsg = [], t.buildingState = !0, t.ws = t._makeStream()
    }, t._makeStream = function () {
      var n = new WebSocket(t.url + "/" + t.lowerCaseSymbol + "@aggTrade.b10");
      return n.onopen = function () {
        window.console.log("Socket has been opened for: " + t.symbol + "!"), t.lastConntectTime = new Date, t._buildState(), clearInterval(void 0)
      }, n.onclose = function (e) {
        window.console.log("Socket has been CLOSED for: " + t.symbol + "!"), n.HandClose ? (n.HandClose = !1, window.console.log("Socket done!")) : (new Date).getTime() - t.lastConntectTime.getTime() < 12e4 ? setTimeout(function () {
          window.console.log("streamer reconntect delay=========="), t._rolloverStream()
        }, 1e3) : (window.console.log("streamer reconntect now=========="), t._rolloverStream())
      }, n.onmessage = function (e) {
        var n = JSON.parse(e.data);
        window.console.log("WS recv: " + n), n = t.converter(n), t.buildingState ? (t.backedMsg.push(n), window.console.log("Adding msg to backlog: " + n)) : t.processData(n)
        ...
        r.method = "get", r.url = t.root_url + "/aggTrades", r.params = {
          ...
          window.console.log("streamer reconntect now=========="), t.stopStream(), t._rolloverStream()
        }, 6e4)
      }, n
      ...
      n.method = "get", n.url = t.root_url + "/aggTrades", n.params = {
        ...
        if (window.console.log("Successfully Get Trades Second Time"), tradeSymbol == t.symbol) {
          t.lastAggTradeId = -1;
          var n = {};
          ...
          window.console.log("Initial state set!"), window.console.log("Replaying " + t.backedMsg.length + " backed msgs!");
          for (var o = t.backedMsg.shift(); o;) t.processData(o), window.console.log("Replayed: " + o.eventType), o = t.backedMsg.shift();
          if (t.buildingState = !1, window.console.log("Replaying DONE! " + t.backedMsg.length + " backed msgs remain."), 0 != t.backedMsg.length) for (window.console.log("OMG!! ME SMASH!!! GIVE ME A REAL THREADING MODEL PLEASE!!"), o = t.backedMsg.shift(); o;) t.processData(o), o = t.backedMsg.shift()
        }
      })
      ...
      var t = {};
      return t.eventType = "aggTrade" == e.e && "trade", t.eventTime = e.E, t.symbol = e.s, t.kline = e.k, "trade" == t.eventType ? (t.aggTradeId = e.a, t.event = e.e, t.eventTime = e.E, t.firstTradeId = e.f, t.lastTradeId = e.l, t.price = e.p, t.qty = e.q, t.symbol = e.s, t.time = e.T, t.isBuyerMaker = e.m) : (window.console.log("Error! Bad data received:"), window.console.log(t)), t
  ...
  return function () {
    ...
    return e.isRunning = !1, e.restart = !1, e.startStream = function (t, n) {
      ...
      return n.websocketStatus = "connecting", t.onopen = function () {
        n.websocketStatus = "connected", window.console.log("Socket has been opened for: market data!"), e.lastConntectTime = new Date, e._buildState()
      }, t.onclose = function (t) {
        window.console.log("Socket has been CLOSED for: market data!"), e.restart ? (n.websocketStatus = "reconnecting", (new Date).getTime() - e.lastConntectTime.getTime() < 12e4 ? setTimeout(function () {
          window.console.log("streamer reconntect delay=========="), e._rolloverStream()
        }, 1e3) : (window.console.log("streamer reconntect now=========="), e._rolloverStream())) : (delete e.ws, window.console.log("Socket done!"))
      }, t.onerror = function () {
        n.websocketStatus = "error"
        ...
        var n = JSON.parse(t.data);
        n = e.converter(n), window.console.log("Market data WS recv, symbol: " + n.symbol + ", lastUpdateTime: " + n.lastUpdateTime), e.buildingState ? (e.backedMsg.push(n), window.console.log("Adding msg to backlog: " + n.eventType)) : e.processData(n)
      }, t
    }, e._buildState = function () {
      e.buildingState = !1
    }, e.converter = function (e) {
  ...
  return {
    request: function (e) {
      ...
      if (window.console.log(t), 401 == t.status) {
        var n = new Date;
